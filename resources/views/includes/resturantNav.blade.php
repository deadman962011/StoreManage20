<nav id="sidebar" class=''>
    ...
    <ul class="list-unstyled components">
      <li><a href="{{ route("StoreMain",['StoreType'=>$StoreType,'StoreId'=>$StoreId]  )}}"><span class="glyphicon glyphicon-list-alt"></span>  {{ trans("lang.SideNavStatitics") }}</a></li>
     ...
     <li><a href="{{ route("Sales",['StoreType'=>$StoreType,'StoreId'=>$StoreId]  ) }}"><span class="glyphicon glyphicon-usd"></span>    {{trans("lang.SideNavSales")}}     </a></li>
        ...
        <li class="">
            <a href="#StoresSubmenu" data-toggle="collapse" aria-expanded="false"><span class="glyphicon glyphicon-shopping-cart"></span>    {{ trans("lang.SideNavStores") }}    </a>
        ...
        <li>
            <a href="#resturanSub" data-toggle="collapse" aria-expanded="false"> <span class="glyphicon glyphicon-cutlery"></span>    {{ trans("lang.SideNavResturant")}}    </a>
             <ul class="collapse list-unstyled" id="resturanSub">
               <li><a href="{{ route("Tables",["StoreType"=>$StoreType,"StoreId"=>$StoreId]) }}">  {{ trans("lang.SideNavResTable")}}</a></li>
               <li><a href="{{ route("Kitchen",["StoreType"=>$StoreType,"StoreId"=>$StoreId]) }}">{{ trans("lang.SideNavResKitchen") }}</a></li>
               <li><a href="{{ route("Delivery",["StoreType"=>$StoreType,"StoreId"=>$StoreId])}}">{{ trans("lang.SideNavDelivery")}}</a></li>
               <li><a href="{{ route("Waiter",["StoreType"=>$StoreType,"StoreId"=>$StoreId])}}">{{ trans("lang.SideNavWaiter")}}</a></li>
